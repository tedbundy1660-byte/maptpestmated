      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-0">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input type="text" name="firstName" required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:bg-white transition-all" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700 uppercase tracking-wider">Last Name</label>
                  <input type="text" name="lastName" required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:bg-white transition-all" />
                </div>
              </div>
              
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700 uppercase tracking-wider">Email Address</label>
                <input type="email" name="email" required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:bg-white transition-all" />
              </div>
          ...
          <div className="space-y-8 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@mapstoestimates.com" className="text-slate-600 hover:text-amber-500 transition-colors">info@mapstoestimates.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+16572141380" className="text-slate-600 hover:text-amber-500 transition-colors">(657) 214-1380</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://share.google/PWtcGzQQc4JMSTT83" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-amber-500 transition-colors font-medium">View our Google Maps Profile</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Google Maps Embed */}
            <div className="w-full h-48 bg-slate-200 rounded-2xl overflow-hidden mt-8 border border-slate-200">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m3!1d3153.019280338781!2d-122.39572422329712!3d37.78964347198126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858066f1c79a95%3A0xc3af8cfb3cd20df2!2s100%20Innovation%20Way%2C%20San%20Francisco%2C%20CA%2094105!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
